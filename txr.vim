...
syn keyword tl_keyword contained sys:build-key-list-expr sys:capture-cont sys:catch sys:check-slot
syn keyword tl_keyword contained sys:check-struct sys:circref sys:compat sys:compile-and-match
...
syn keyword tl_keyword contained sys:compile-range-match sys:compile-require-match sys:compile-struct-match sys:compile-var-match
...
syn keyword tl_keyword contained sys:defset-expander sys:defset-expander-simple sys:dig sys:disassemble-cdf
...
syn keyword tl_keyword contained sys:ensure-op-arg sys:env-to-let sys:eval-err sys:expand-and
...
syn keyword tl_keyword contained sys:quasilist sys:r-s-let-expander sys:reduce-or sys:reg-expand-nongreedy
...
syn keyword tl_keyword contained sys:subst sys:switch sys:sym-clobber-expander sys:sym-delete-expander
