...
syn keyword tl_keyword contained sys:*eval* sys:*load-recursive* sys:*load-time* sys:*op-ctx*
...
syn keyword tl_keyword contained sys:bindable-check sys:bits sys:bits-to-obj sys:build-expander
...
syn keyword tl_keyword contained sys:expand-each-prod sys:expand-each-prod* sys:expand-handle sys:expand-params
...
syn keyword tl_keyword contained sys:uw-handle sys:uw-menv sys:var sys:vars-check
