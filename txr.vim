...
syn keyword tl_keyword contained sys:get-param-info sys:get-parser sys:get-place-macro sys:get-var-list
...
syn keyword tl_keyword contained sys:parser-eof sys:parser-errors sys:pat-len sys:path-access
...
syn region txr_ign_tok contained matchgroup=Comment start="#;" end="[ \(\)\[\]]"me=e contains=txr_string,tl_regex,txr_num,txr_pnum,tl_ident,txr_metanum,txr_quasilit,txr_chr,txr_buf,txr_quote,txr_unquote,txr_splice,txr_dot,txr_dotdot,txr_metaat,txr_circ,txr_ncomment
