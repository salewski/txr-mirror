...
syn keyword tl_keyword contained sys:%sm-lev-size% sys:%test-funs% sys:%test-funs-neg% sys:%test-funs-pos%
syn keyword tl_keyword contained sys:%test-inv% sys:%tlo-ver% sys:*emit* sys:*eval*
...
syn keyword tl_keyword contained sys:apply sys:asm-error sys:awk%--rng sys:awk%--rng+
...
syn keyword tl_keyword contained sys:compat sys:compile-in-toplevel sys:conv sys:conv-expand
...
syn keyword tl_keyword contained sys:enc-small-op sys:ensure-op-arg sys:eval-err sys:expand
syn keyword tl_keyword contained sys:expand* sys:expand-bind-mac-params sys:expand-defmacro sys:expand-defsymacro
