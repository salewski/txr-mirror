...
syn keyword tl_keyword contained copy-buf copy-carray copy-cons copy-hash
...
syn keyword tl_keyword contained sys:each-op sys:enc-small-op sys:ensure-op-arg sys:eval-err
...
syn keyword tl_keyword contained sys:expand-quasi-mods sys:expr sys:extract-keys sys:extract-keys-p
